...
public class ViewAlternativaDeSolucaoNovo extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAlternativaDeSolucaoNovo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewAlternativaDeSolucaoNovo dialog = new ViewAlternativaDeSolucaoNovo(new javax.swing.JFrame(), true);

 ...
 * @author Bleno Vale
 */
public class ViewCriteriosDeAvaliacao extends javax.swing.JInternalFrame {

    public ViewCriteriosDeAvaliacao() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        new ViewCriteriosDeAvaliacaoNovo(null, true).setVisible(true); 

 ...
 * @author Bleno Vale
 */
public class ViewGuiaGestaoDeDecisaoAntigo extends javax.swing.JInternalFrame {

    private int type;
    private Request request;
    private ControllerGuia controllerGuia = new ControllerGuia();

    public ViewGuiaGestaoDeDecisaoAntigo() {
        initComponents();
    ...
    private void saveManual() {
        ...
        isDone = controllerGuia.createItemGuia(list);
    ...
    private void initComponents() {
        ...
        jPanelInsecaoManualLayout.setVerticalGroup(
            jPanelInsecaoManualLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanelInsecaoManualLayout.createSequentialGroup()
                .addComponent(jTextArea, javax.swing.GroupLayout.PREFERRED_SIZE, 282, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
